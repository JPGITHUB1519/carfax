      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
         ...
         <div class="panel-footer">
                <a href="mailto:<?php echo $usuario[6] ?>" data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-envelope"></i></a>
